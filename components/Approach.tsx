        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description="Planning is setting goals and outlining steps to achieve them.Strategies are methods and approaches to reach these goals.Both ensure efficient resource use and help navigate challenges.">
                    <CanvasRevealEffect
                        animationSpeed={5.1}
